...
export const fr = {
  ...
  'library.empty': 'Aucun groupe pour l’instant.',
  'library.group': 'Groupe',
  'library.repertoire': 'Répertoire',
  ...
  'library.count.song.other': '{count} chansons',
  'library.count.track.one': '{count} piste',
  'library.count.track.other': '{count} pistes',
  'library.addGroup': 'Nouveau groupe',
  'library.addRepertoire': 'Nouveau répertoire',
  'library.addSong': 'Nouvelle chanson',
  ...
  'library.expand': 'Développer {name}',
  'library.collapse': 'Réduire {name}',
  'library.error': 'Action impossible. Réessaie.',
  'library.public': 'Rendre publique',
  ...
  'library.share.copied': 'Lien copié',
  'library.share.whatsapp': 'WhatsApp',
  'library.share.native': 'Partager…',
