...
const variants: Record<ButtonVariant, string> = {
  ...
  transport: cn(
    'm-0 inline-flex h-[4.1rem] w-[4.1rem] items-center justify-center rounded-full border-[2.5px] border-line bg-white p-0 text-ink leading-none',
    'shadow-[0_8px_22px_rgba(15,61,62,0.12),inset_0_1px_0_rgba(255,255,255,0.7)]',
    'hover:enabled:-translate-y-0.5 hover:enabled:shadow-[0_12px_28px_rgba(15,61,62,0.16),inset_0_1px_0_rgba(255,255,255,0.75)]',
  ...
  utility: cn(
    ...
    'text-[0.78rem] font-semibold leading-none text-[rgba(15,61,62,0.55)]',
    'hover:border-[rgba(15,61,62,0.08)] hover:bg-[rgba(15,61,62,0.06)] hover:text-ink-soft',
    'focus-visible:outline focus-visible:outline-2 focus-visible:outline-[rgba(15,61,62,0.35)] focus-visible:outline-offset-2',
  ...
  trim: cn(
    ...
    'hover:enabled:-translate-y-px hover:enabled:bg-[rgba(15,61,62,0.06)]',
  ...
  trash: cn(
    ...
    'hover:enabled:-translate-y-px hover:enabled:border-[rgba(226,61,61,0.35)] hover:enabled:bg-[rgba(226,61,61,0.1)] hover:enabled:text-record',
    'active:enabled:translate-y-px active:enabled:scale-[0.98]',
  ),
  round: cn(
