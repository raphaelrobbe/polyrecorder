  ...
  return (
    <table
      className={cn(
        ...
        '[&_td]:border-b [&_td]:border-[rgba(15,61,62,0.1)] [&_td]:px-[0.55rem] [&_td]:py-[0.4rem] [&_td]:align-top [&_td]:text-left',
...
export function HelpShortcutsCategory({ children }: HelpShortcutsCategoryProps) {
  return (
    <tr>
      <td
        colSpan={2}
        className="border-b border-[rgba(15,61,62,0.08)] bg-[rgba(15,61,62,0.06)] px-[0.55rem] py-[0.45rem] text-[0.72rem] font-bold tracking-[0.06em] whitespace-normal text-ink-soft uppercase"
      >
        {children}
      </td>
    </tr>
